    ...
    <ContactContainer id="contact"> 
      ...
      <ContactForm>
        ...
        <form onSubmit={onSubmit}>
          ...
          <FormInput type="email" id="email" name="email" placeholder="Enter your email" required />
          <FormLabel htmlFor="message">Write your message here</FormLabel>
          <FormTextArea id="message" name="message" rows="5" placeholder="Enter your message" required />
